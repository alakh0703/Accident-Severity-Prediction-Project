# -*- coding: utf-8 -*-
"""
Created on Tue Mar  7 23:27:40 2023
...
dataset = data.drop(['INDEX_','ACCNUM','YEAR','DATE','OFFSET','LATITUDE','LONGITUDE','WARDNUM','ACCLOC','FATAL_NO',
                 'INITDIR','VEHTYPE','MANOEUVER','PEDTYPE','PEDACT','PEDCOND','CYCLISTYPE','CYCACT','CYCCOND',
                 'NEIGHBOURHOOD_158','X','Y','IMPACTYPE','ACCLASS','INVTYPE','STREET1','STREET2','NEIGHBOURHOOD_140','HOOD_140','DIVISION','ObjectId','HOOD_158'], axis = 1)
